...

{
    ...
    glBegin(GL_POLYGON);
     ...
     glEnd();
         ...
         glColor3f(0.1, 0.0, 0.5) ;    //trin 1 main
         glBegin(GL_POLYGON);
     ...
     glEnd();
        ...
        glColor3f(0.1, 0.5, 0.0) ;     //trn2 main
         glBegin(GL_POLYGON);
     ...
     glEnd();
          ...
          glColor3f(0.0, 0.1, 0.5) ;   //trn3 main
          glBegin(GL_POLYGON);
     ...
     glEnd();
         ...
         glColor3f(0.0, 0.5, 0.1) ;   //trn4 main
         glBegin(GL_POLYGON);
     ...
     glEnd();
         ...
         glColor3f(0.5, 0.0, 0.1) ;   //trn5 main
         glBegin(GL_POLYGON);
     ...
     glEnd();
         ...
         glColor3f(0.5, 0.1, 0.0) ;     //trn6 main
         glBegin(GL_POLYGON);
 ...
 int main (int argc, char **argv)
 {
     ...
     glutCreateWindow ("National Memorial ID: 182-15-2105");
